    ...
    choices: [
      {
        id: "corp",
        label: "A",
        text: "Accept the corporate offer.",
        sub: "Stable salary. Health insurance. A corner office someday, maybe.",
      },
      {
        id: "startup",
        label: "B",
        text: "Join your college friend's startup.",
        sub: "No salary yet. Just equity, energy, and a shared Google Doc.",
      },
      {
        id: "travel",
        label: "C",
        text: "Buy a one-way ticket to Lisbon.",
        sub: "No plan. Just savings, a backpack, and a need to feel something.",
      },
    ],
  },
    ...
    choices: [
      {
        id: "corp_stay",
        label: "A",
        text: "Stay. The stability is earned.",
        sub: "Decline the offer. Double down on the promotion track.",
      },
      {
        id: "corp_leap",
        label: "B",
        text: "Take the leap. Join them.",
        sub: "Terrifying. But you've been safe for two years.",
      },
    ],
  },
    ...
    choices: [
      {
        id: "startup_pivot",
        label: "A",
        text: "Pivot. Kill the original idea.",
        sub: "Gut the roadmap. Build what the market actually wants.",
      },
      {
        id: "startup_quit",
        label: "B",
        text: "Fold it. Walk away.",
        sub: "Take the lesson. Find something stable before trying again.",
      },
    ],
  },
    ...
    choices: [
      {
        id: "travel_partner",
        label: "A",
        text: "Miguel — a designer with a business idea.",
        sub: "He wants to build a remote-first studio. He needs a technical co-founder.",
      },
      {
        id: "travel_love",
        label: "B",
        text: "Amara — a writer, a whole world.",
        sub: "She's leaving for Nairobi in a month. You could go with her.",
      },
    ],
  },
...
function updateProgress(chapter) {
  ...
  for (let i = 1; i <= TOTAL_CHAPTERS; i++) {
    ...
    d.className =
      "chapter-dot" + (i < chapter ? " done" : i === chapter ? " active" : "");
    dots.appendChild(d);
  }
}
...
function buildEnding(node, scene, text) {
  ...
  const labels = {
    success: "✦ Strong Outcome",
    mixed: "◈ Mixed Outcome",
    regret: "◇ Reflective Ending",
  };
  ...
  note.style.cssText =
    "font-size:0.68rem;color:var(--muted);margin-top:0.8rem;font-style:italic;";
...
function updateHistoryPanel() {
  ...
  if (history.length === 0) {
    list.innerHTML =
      '<div style="font-size:0.7rem;color:var(--muted)">No choices made yet.</div>';
    return;
  }
